...
public class ConsCalculator01 {

    public static <Addition, Subtraction, Multiplication, Division> void main(String Args[]) {

        Scanner scan = new Scanner(System.in);
        int typeOfOperation;

        System.out.print("\n\n********* <3 Welcome to Calculator <3 ********* \n\nwhat kind of operation would you like to perform?\n");
...
//            System.out.println("The result of Addition operation is : " + add.add());
